...
class AdminAddEditController extends BaseController
{
	public function renderEditPage(string $entityToEdit, int $entityId): string
	{
		try
		{
			...
			switch (get_class($entity))
			{
				...
				case Tag::class:
				{
					$data = Tag::fillAddEditPage($entity);
					$content = TemplateEngine::render('pages/adminEditPage', [
						'entity' => $entity,
						'specificFields' => $data['specificFields'],
					]);
				...
				case Order::class:
				{
					$data = Order::fillAddEditPage($entity);
					$content = TemplateEngine::render('pages/adminEditPage', [
						'entity' => $entity,
						'specificFields' => $data['specificFields'],
					]);
